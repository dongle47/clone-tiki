...
function ReviewProduct() {
    return (
        <Box className="container" sx={{backgroundColor:"#fff"}}>
                ...
                <Box sx={{ flex: 1 }}>
                    ...
                    <Stack direction="row" alignItems={"center"} spacing={2} mt={4}>
                        ...
                        <div className='ReviewProduct__Filter Selected'>
                            <CheckIcon sx={{color:"rgb(26, 148, 255)", fontSize:"16px"}} mr={1}/>
                            Mới nhất
                        </div>
                        ...
                        <div className='ReviewProduct__Filter Selected'>
                            <CheckIcon sx={{color:"rgb(26, 148, 255)", fontSize:"16px"}}/>
            ...
            <Stack direction="row" sx={{padding:"32px 48px 24px", borderBottom:"1px solid #BFBFBf"}}>
                <Box sx={{ width: "335px"}}>
                    ...
                    <Stack direction="column">                      
                        <Stack direction="row" mt={2}>
                            ...
                            <Typography>Đã viết: </Typography>
                            <Typography ml={1}>1 đánh giá</Typography>
                        </Stack>
                        <Stack direction="row" mt={2}>
                            <div className='IconWritten'>
                                <img src="https://salt.tikicdn.com/ts/upload/cc/86/cd/1d5ac6d4e00abbf6aa4e4636489c9d80.png" alt="" /> 
                            </div>
                            <Typography sx={{fontSize:"13"}}>Đã nhận: </Typography>
                            <Typography sx={{fontSize:"13"}} ml={1}>0 Lượt cám ơn</Typography>
                        </Stack>
                    </Stack>
                </Box>
                <Box sx={{ flex: 1 }}>
