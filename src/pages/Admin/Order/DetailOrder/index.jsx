...
function DetailOrder() {
    return (
        ...
        <Box>
            <Stack backgroundColor="white" p={2}>
                <Typography mt={2.5} mx={2} sx={{ fontSize: "22px", fontWeight: 300 }}>Chi tiết đơn hàng #825345038 - <span style={{ fontWeight: 500 }}>Huỷ</span></Typography>
            ...
            <Stack direction="row" mt={1.25} mb={2.5} className="detailOrder" jutifyContent="space-between" mx={2}>
                <Box sx={{ flex: 1 }} p={2} backgroundColor="white">
            ...
            <Stack backgroundColor="white" mx={2}>
                <Stack direction="row">
