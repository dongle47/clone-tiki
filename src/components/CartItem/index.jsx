    ...
    return (
        <>
            <div className="cart-item">
                <div className="cart-item__cell cart-item__description" style={{ width: "44.45%" }}>
                    <Checkbox checked={data?.choose} onChange={handleChangeChoose}
                        sx={{ padding: 0, marginRight: "12px", width: "18px", height: "18px" }} />
                    <img src={data?.image} alt="" />

                    <div className="cart-item__description__content">
                        <Typography className="cart-item__description__text" gutterBottom variant="h5" component="div">
                            {data?.name}
                        </Typography>
                    </div>
                </div>
                <div className="cart-item__cell cart-item__price" style={{ width: "21.11%" }}>{numWithCommas(data?.price)} ₫</div>
                <div className="cart-item__cell" style={{ width: "14.45%" }}>
                    <div className="cart-item__quanlity">
                        <button onClick={() => { updateQuanlity("-") }}>-</button>
